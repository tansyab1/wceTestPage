...
<head>
  <title>WCE Test Instruction</title>
  ...
  <div>
    ...
    <div class="home-container">
      ...
      <div class="home-banner">
        <h1 class="home-text01">Experiment Instruction</h1>
        <span class="home-text02">
          <span>
            On each page you will be presented with a pair of video
            reproductions (left:
          </span>
          <span class="home-text04">Distorted</span>
          <span>video ; right:</span>
          <span class="home-text06">Reference</span>
          <span>video).</span>
          <br />
          <br />
          <br />
          <span class="home-text11">Step 1</span>
          <span>: Press "</span>
          <span class="home-text13">Play</span>
          <span>" button to start the videos.</span>
          <br />
          <br />
          <span class="home-text17">Step 2</span>
          <span>
            :&nbsp;Using your skill and judgement, please give each pair a
            rating
          </span>
          ...
          <br />
          <br />
          <span class="home-text27">Step 3</span>
          <span>: Press "</span>
          <span class="home-text29">Next</span>
          <span>
            " button to skip to the next pair. The assessment result is saved
            automatically.
          </span>
          <br />
          <br />
          <span class="home-text33">Note</span>
          <span>: If you want to stop video, please press</span>
          <span class="home-text35">"Stop"</span>
          <span>button.</span>
          <!-- new line -->
          <br />
          <br />
          <span class="home-text39" style="color:red;"> The assessment result will be saved after each 10 video pairs. Moreover, the experiment can be processed in <b>several times</b>. <i>You can stop the experiment at any time and come back later to continue.</i> </span>
          <br />
        </span>
        <a href="/~tansy.nguyen/index-exp.php" target="_parent"><button class="home-button button">I understand</button></a>
      </div>
    </div>
  </div>
