...
<head>
  <title>Blind Test Instruction</title>
  ...
  <div>
    ...
    <div class="home-container">
      ...
      <div class="home-banner">
        <h1 class="home-text01">Image Familiarization</h1>
        <span class="home-text02">
          <span>
            The next few pages will give you an overview of the range of
            visual differences corresponding to each kind of distortions you
            are likely to encounter in the experiment.
          </span>
          <br />
          <br />
          <span>There will be several versions of each image.</span>
          <br />
          <span></span>
          <span></span>
        </span>
        <a href="/~tansy.nguyen/src/testVisual/visualTest.php" target="_parent"><button class="home-button button">Next</button></a>
      </div>
    </div>
  </div>
