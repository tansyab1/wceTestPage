    ...
    <div>
      ...
      <div class="home-container">
        ...
        <div class="home-banner">
          <h1 class="home-text01">All data is anonymized</h1>
          <span class="home-text02">
            <span>
              The responses you give will be held on a publicly accessible
              server, and used in conjunction with other participants to form a
              visual study.
            </span>
            <br />
            <br />
            <span>
              In addition, you can leave anonymous feedback and participant
              information.
            </span>
            <br />
            <br />
            <span>If you are happy to proceed, please press the</span>
            <span class="home-text10">Consent</span>
            <span>button to confirm.</span>
            <br />
            <span>Otherwise, please press '</span>
            <span class="home-text14">Esc</span>
            <span>' or close the window to leave the experiment.</span>
            <br />
            <span></span>
            <span></span>
          </span>
          <a href="/~tansy.nguyen/src/imageFam/imageFam.php" target="_parent"><button class="home-button button">I consent</button></a>
        </div>
      </div>
    </div>
    <script
